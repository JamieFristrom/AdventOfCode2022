...
fn simulate(jet_streams: &Vec<i64>, num_rocks: usize) -> Vec<Vec<u8>> {    
...
fn drop_rock(board: &mut Vec<Vec<u8>>, rock_type: usize, jet_streams: &[i64], mut jet_stream_idx: usize) -> usize {
